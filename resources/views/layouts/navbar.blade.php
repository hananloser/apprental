        ...
        <nav id="navbar-main" class="navbar navbar-main navbar-expand-lg navbar-transparent bg-default  headroom">
            <div class="container">
                <a class="navbar-brand mr-lg-5" href="/">
                    <i class="fa fa-car display-3"></i> 
                </a>
                <span class=" display-3 text-white">iRent</span>
                    ...
                    <div class="navbar-collapse-header">
                        <div class="row">
                            <div class="col-6 collapse-brand">
                                <a href="">
                                   <i class="fa fa-car display-2"></i>
                                   <span class="font-weight-100 display-3  mx-2">iRent</span>
                                </a>
                            </div>
